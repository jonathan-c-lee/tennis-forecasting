...
if __name__ == '__main__':
    """Error metrics for trajectory prediction model."""
    ...
    # test_list = []
    # for i in range(20):
    #     model_name = f'trajectory_predictor_0_{20*(i+17)}'
    #     model = TrajectoryPredictor(
    #         output_frames,
    #         position_dim,
    #         pose_size,
    ...
    """Evaluating final trajectory prediction position only model."""
    # dirname = os.path.dirname(__file__)
    # input_frames = 6
    # output_frames = 15
    # position_dim = 4
    ...
    """Evaluating tuning trajectory prediction position only models."""
    # dirname = os.path.dirname(__file__)
    # input_frames = 6
    # output_frames = 15
    # position_dim = 4
